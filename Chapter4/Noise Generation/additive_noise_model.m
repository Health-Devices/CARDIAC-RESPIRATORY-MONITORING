...
if plotting ==1
    ...
    N=4096*2;
    N1=256;
    stft(noise,fs,'Window',hamming(N1),'OverlapLength',N1/2,'FFTLength',N, 'FrequencyRange',"onesided");
    ylim([0 64])
    %title('STFT of the Gaussian noise and motion artifacts')
    title('STFT of the Gaussian and bandlimited impulse noise')
    %title('STFT of the Gaussian and impulse noise')
end
